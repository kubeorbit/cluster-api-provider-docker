...
import (
	...
	infrastructurev1alpha1 "github.com/kubeorbit/cluster-api-provider-docker/api/v1alpha1"
	"github.com/kubeorbit/cluster-api-provider-docker/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ef08b808.cluster.x-k8s.io",
